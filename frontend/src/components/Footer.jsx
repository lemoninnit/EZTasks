...
export default function Footer({ minimal = false }) {
  const s = {
    footer: { background: '#05050f', color: '#f8fafc', padding: minimal ? '40px 24px 24px' : '80px 24px 24px', fontSize: 14, borderTop: '1px solid rgba(255,255,255,0.05)' },
    ...
    bottom: { maxWidth: 1000, margin: minimal ? '0 auto' : '64px auto 0', borderTop: minimal ? 'none' : '1px solid rgba(255, 255, 255, 0.05)', paddingTop: minimal ? 0 : 32, paddingBottom: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16, color: 'rgba(255,255,255,0.4)' },
